<figure class="thumb" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">\
              ...
              </figure><section class="archives album"><h1 class="year">' + data.year + '<em>' + data.month + '月</em></h1>\
      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            var minSrc = 'https://github.com/Angle-Dream/Blog-Back-Up/master/min_photos/' + data.link[i];
            var src = 'https://github.com/Angle-Dream/Blog-Back-Up/master/photos/' + data.link[i];
